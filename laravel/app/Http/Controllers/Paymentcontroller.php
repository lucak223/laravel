...
class Paymentcontroller extends Controller
{
    ...
    public function __construct(){
        ...
        $this->vnp_TmnCode = "JMYE1WJQ"; //Mã định danh merchant kết nối (Terminal Id)
        $this->vnp_HashSecret = "RRLENGHGFZHOBMMJYEI1XOIIN75M14CR"; //Secret key
    ...
    public function create(){
        $order = new Order();
        $order->user_id = 1; // Lấy id đã đăng nhập
